...
<div class="wrap">
	...
	<div class="metabox-prefs">
		<div class="wrap about-wrap" style="position:relative;">
			...
			<p class="about-text">If you are interested in HTML, Javascript or Service Worker optimization, check out our <a href="<?php print esc_url(add_query_arg(array('s' => 'o10n', 'tab' => 'search', 'type' => 'author'), admin_url('plugin-install.php'))); ?>">other plugins</a> that are designed to cooperate with this plugin.</p>
